...
public interface GoodsSkuMapper extends BaseMapper<GoodsSku> {
     ...
     * @return 订单支付记录分页
     */
    @Select("select * from li_goods_sku as me  ${ew.customSqlSegment} ")
    IPage<GoodsSku> queryGoodsSkuList(IPage<GoodsSku> page, @Param(Constants.WRAPPER) Wrapper<GoodsSku> queryWrapper);
