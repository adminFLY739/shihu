...
public interface CategoryService extends IService<Category> {
     ...
     * @return 分类树
     */
    List<CategoryVO> categoryTree(String tenantId);
     ...
     * @return 所有的分类，父子关系
     */
    List<CategoryVO> listAllChildren(String parentId,String tenantId);
     ...
     * @return 所有的分类，父子关系
     */
    List<CategoryVO> listAllChildrens(String tenantId);
     ...
     * @return 分类名称集合
     */
    List<String> getCategoryNameByIds(List<String> ids,String tenantId);
     ...
     * @return 分类VO列表
     */
    List<CategoryVO> getStoreCategory(String[] categories,String tenantId);
    ...
    @Cacheable(key = "#id")
    List<Category> getItem(String id);
