...
public class Goods extends BaseEntity {
    ...
    @ApiModelProperty(value = "是否是需求商品",required = true)
    ...
    private String goodsCampusName;
    ...
    public Goods(GoodsOperationDTO goodsOperationDTO) {
        ...
        this.tenantId = goodsOperationDTO.getTenantId();
        this.isNeedGoods=goodsOperationDTO.getIsNeedGoods();
        this.goodsCampus=goodsOperationDTO.getGoodsCampus();
        this.goodsCampusName=goodsOperationDTO.getGoodsCampusName();
