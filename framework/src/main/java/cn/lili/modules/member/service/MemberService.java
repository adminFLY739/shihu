...
public interface MemberService extends IService<Member> {
     ...
     * @return 会员
     */
    Member updateMember(ManagerMemberEditDTO managerMemberEditDTO , List<String> tenantIds);


    /**
     * 用户实名认证申请
     * @param memberRealNameDTO
     * @return
     */
    boolean userRealNameApplying(MemberRealNameDTO memberRealNameDTO);
     ...
     * @return 修改结果
     */
    Boolean updateHZNUSHMemberStatus(List<String> memberIds, Boolean status);
    ...
    *@date: 2023/6/25
    */
    List<Tenant> getMemberTenantList(String id);
