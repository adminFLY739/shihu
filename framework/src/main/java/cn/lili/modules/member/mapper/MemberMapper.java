...
public interface MemberMapper extends BaseMapper<Member> {
    ...
    IPage<Member> pageByMember(IPage<Member> page, @Param(Constants.WRAPPER) Wrapper<Member> queryWrapper);

    @Update("UPDATE li_member SET username=#{username},student_id=#{studentId} WHERE id=#{id}")
