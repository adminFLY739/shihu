...
public class KanjiaActivityServiceImpl extends ServiceImpl<KanJiaActivityMapper, KanjiaActivity> implements KanjiaActivityService {
    ...
    public KanjiaActivityLog add(String id) {
        ...
        if (goodsSku != null) {
            ...
            //剩余砍价金额 开始是商品金额-结算金额
            kanJiaActivity.setSurplusPrice(goodsSku.getPrice()-kanJiaActivityGoods.getSettlementPrice());
            //当前金额
            kanJiaActivity.setPurchasePrice(goodsSku.getPrice());
            //保存我的砍价活动
    ...
    public KanjiaActivityLog helpKanJia(String kanjiaActivityId) {
        ...
        kanjiaActivity.setPurchasePrice(kanjiaActivity.getPurchasePrice()-price);
    ...
    public IPage<KanjiaActivity> getForPage(KanjiaActivityQuery kanjiaActivityQuery, PageVO page) {
        ...
        return baseMapper.queryKanjiaActivityGoods(PageUtil.initPage(page), queryWrapper);
    }
