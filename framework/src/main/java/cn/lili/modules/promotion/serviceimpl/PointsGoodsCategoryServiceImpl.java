...
public class PointsGoodsCategoryServiceImpl extends ServiceImpl<PointsGoodsCategoryMapper, PointsGoodsCategory> implements PointsGoodsCategoryService {
    ...
    public boolean addCategory(PointsGoodsCategory pointsGoodsCategory) {
        this.checkNameDuplicate(pointsGoodsCategory.getName(), null,pointsGoodsCategory.getTenantId());
    ...
    public boolean updateCategory(PointsGoodsCategory pointsGoodsCategory) {
        ...
        this.checkNameDuplicate(pointsGoodsCategory.getName(), pointsGoodsCategory.getId(),pointsGoodsCategory.getTenantId());
     ...
     */
    @Override
    public IPage<PointsGoodsCategory> getCategoryByPage(String name, PageVO page ,String tenantId) {
        ...
        if (CharSequenceUtil.isNotEmpty(tenantId)) {
            queryWrapper.like(PointsGoodsCategory::getTenantId, tenantId);
        }
        page.setOrder("ASC");
    ...
    private void checkNameDuplicate(String name, String id , String tenantId) {
        LambdaQueryWrapper<PointsGoodsCategory> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(PointsGoodsCategory::getName, name);
        queryWrapper.eq(PointsGoodsCategory::getTenantId,tenantId);
        if (id != null) {
