...
public class FullDiscountServiceImpl extends AbstractPromotionsServiceImpl<FullDiscountMapper, FullDiscount> implements FullDiscountService {
    ...
    @Override
    public IPage<FullDiscountVO> queryFullDiscount(IPage<FullDiscountVO> page, Wrapper<FullDiscountVO> queryWrapper) {
        return baseMapper.queryFullDiscount(page, queryWrapper);
    }

    @Override
    public IPage<FullDiscount> storeQueryFullDiscount(IPage<FullDiscount> page, Wrapper<FullDiscount> queryWrapper) {
        return baseMapper.storeQueryFullDiscount(page, queryWrapper);
    }
