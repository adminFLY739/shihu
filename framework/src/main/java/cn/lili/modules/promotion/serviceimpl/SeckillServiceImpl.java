...
public class SeckillServiceImpl extends AbstractPromotionsServiceImpl<SeckillMapper, Seckill> implements SeckillService {
    ...
    @Override
    public IPage<SeckillVO> querySeckill(IPage<SeckillVO> page, Wrapper<SeckillVO> queryWrapper) {
        return baseMapper.querySeckill(page, queryWrapper);
    }

    @Override
    public IPage<Seckill> storeQuerySeckill(IPage<Seckill> page, Wrapper<Seckill> queryWrapper) {
        return baseMapper.storeQuerySeckill(page, queryWrapper);
    }
