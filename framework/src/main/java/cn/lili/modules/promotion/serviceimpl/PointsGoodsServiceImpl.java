...
public class PointsGoodsServiceImpl extends AbstractPromotionsServiceImpl<PointsGoodsMapper, PointsGoods> implements PointsGoodsService {
    ...
    @Override
    public IPage<PointsGoodsVO> queryPointsGoods(IPage<PointsGoodsVO> page, Wrapper<PointsGoodsVO> queryWrapper) {
        return baseMapper.queryPointsGoods(page, queryWrapper);
    }
