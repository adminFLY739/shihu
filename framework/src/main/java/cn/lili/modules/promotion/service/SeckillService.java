...
public interface SeckillService extends AbstractPromotionsService<Seckill> {
     ...
     * @return 订单支付记录分页
     */
    IPage<SeckillVO> querySeckill(IPage<SeckillVO> page, Wrapper<SeckillVO> queryWrapper);
     ...
     * @return 订单支付记录分页
     */
    IPage<Seckill> storeQuerySeckill(IPage<Seckill> page, Wrapper<Seckill> queryWrapper);
