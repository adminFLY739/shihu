...
public class StoreDetailServiceImpl extends ServiceImpl<StoreDetailMapper, StoreDetail> implements StoreDetailService {
    ...
    @Override
    public StoreDetailVO getStoreDetailVO(String storeId , String tenantId) {
        StoreDetailVO storeDetailVO = (StoreDetailVO) cache.get(CachePrefix.STORE.getPrefix() + storeId);
        if (storeDetailVO == null) {
            storeDetailVO = this.baseMapper.getStoreDetail(storeId , tenantId);
    ...
    @Override
    public StoreDetailVO getStoreDetailVOByMemberId(String memberId,String tenantId) {
        return this.baseMapper.getStoreDetailByMemberId(memberId,tenantId);
    }
    ...
    public StoreDeliverGoodsAddressDTO getStoreDeliverGoodsAddressDto() {
        String storeId = Objects.requireNonNull(Objects.requireNonNull(UserContext.getCurrentUser()).getStoreId());
