...
public interface OrderMapper extends BaseMapper<Order> {
     ...
     * @return 订单支付记录分页
     */
    @Select("select me.* from li_order as me LEFT JOIN li_order_item AS oi on me.sn = oi.order_sn ${ew.customSqlSegment} ")
    ...
    @Select("select o.sn,o.flow_price,o.create_time,o.order_status,o.pay_status,o.payment_method,o.payment_time,o.member_name,o.store_name as store_name,o.store_id as store_id,o.client_type,o.order_type,o.deliver_status,o.order_promotion_type " +
            ...
            "FROM li_order o LEFT JOIN li_order_item AS oi on o.sn = oi.order_sn LEFT JOIN li_goods_sku as gs on oi.sku_id = gs.id LEFT JOIN li_shipments_clerk as sc on gs.sn = sc.shipments_id ${ew.customSqlSegment} ")
