...
public interface MemberWalletService extends IService<MemberWallet> {
     ...
     * @return 会员预存款VO
     */
    MemberWalletVO getMemberWallet(String memberId,String tenantId);
     ...
     * @return 操作结果
     */
    MemberWallet save(String memberId, String memberName,String tenantId);
     ...
     * @return 是否提现成功
     */
    Boolean applyWithdrawal(Double price,String tenantId);
