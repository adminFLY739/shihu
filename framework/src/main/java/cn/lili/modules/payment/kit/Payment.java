...
public interface Payment {
     ...
     * @return 二维码内容
     */
    default ResultMessage<Object> mpPay(HttpServletRequest request, PayParam payParam,String appid) {
        throw new ServiceException(ResultCode.PAY_ERROR);
    }
     ...
     * @param request HttpServletRequest
     */
    default void notify(HttpServletRequest request,String appid) {
        throw new ServiceException(ResultCode.PAY_ERROR);
    }
     ...
     * @param request HttpServletRequest
     */
    default void refundNotify(HttpServletRequest request,String appid) {
        throw new ServiceException(ResultCode.PAY_ERROR);
    }
