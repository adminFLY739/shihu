...
public class WalletPlugin implements Payment {
     ...
     * @param payParam 支付参数
     */
    private void savePaymentLog(PayParam payParam,String appid) {
        ...
        try {
            ...
            this.callBack(payParam, cashierParam,appid);
        } finally {
            lock.unlock();
        }
    }
     ...
     */
    public void callBack(PayParam payParam, CashierParam cashierParam,String appid) {
