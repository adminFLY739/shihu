...
public class WechatMpCodeUtil {
     ...
     * @return
     */
    public String createQrCode(String path,String tenantId) {
        try {
            String accessToken = wechatAccessTokenUtil.cgiAccessToken(ClientTypeEnum.WECHAT_MP,tenantId);
     ...
     * @return
     */
    public String createCode(String page, String scene,String tenantId) {
        try {
