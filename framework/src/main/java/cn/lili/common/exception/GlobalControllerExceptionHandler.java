...
public class GlobalControllerExceptionHandler {
    ...
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public ResultMessage<Object> handleLinfengException(HttpServletRequest request, final Exception e, HttpServletResponse response) {
        //如果是自定义异常，则获取异常，返回自定义错误消息
        if (e instanceof LinfengException) {
            LinfengException serviceException = ((LinfengException) e);
