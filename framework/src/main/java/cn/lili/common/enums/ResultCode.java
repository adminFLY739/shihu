...
public enum ResultCode {
    ...
    CATEGORY_HAS_POST(10006, "此类别下存在帖子不能删除"),
    ...
    USER_DEL_ERROR(20015, "用户删除失败，因为已经绑定了店铺，只能禁用该用户"),
    ...
    USER_NOT_REALNAME_ERROR(20038, "用户未实名"),
    ...
    UPDATE_STORE_STATUS_ERROR(20033, "无法取消当前申请"),

    APPLY_MEMBER_TENANT_ERROR(20034, "申请租户失败！"),
    APPLY_MEMBER_TENANT_SUCCESS(20035, "申请租户成功！"),

    APPLY_MEMBER_TENANT_REPEAT(20034, "租户正在审核中或者已通过！"),

    SET_MAIN_TENANT_ERROR(20036,"设置主租户失败"),
    SET_MAIN_TENANT_SUCCESS(20037,"设置主租户成功"),
    /**
     * 权限
     */
    ...
    PERMISSION_TANENT_ERROR(21009, "租户管理员无法删除"),
    ...
    COUPON_EDIT_STATUS_ERROR(41004, "修改状态失败！"),
     ...
     * 卡券
     */
    CARD_SAVE_ERROR(41040, "保存卡券失败"),

    CARD_GET_ERROR(400010, "当前卡券不存在"),

    DELIVERY_STATUS_ERROR(41041,"修改提货码状态失败"),

    DELIVERY_AUTH_ERROR(41042,"卡券提货码认证失败,请重新认证"),

    DELIVERY_GET_ERROR(41043,"卡券编码不存在"),

    DELIVERY_PASSWORD_ERROR(41044,"卡券密码错误"),

    DELIVERY_STATUS_AUTH_ERROR(41045,"该卡券未被激活"),

    CARD_USE_ERROR(41045,"卡券提货失败，请重试"),
    ...
    KANJIA_GOODS_ACTIVE_HIGHEST_PRICE_ERROR(48003, "最高砍价金额不能为0且不能超过商品可砍金额"),
    KANJIA_GOODS_ACTIVE_LOWEST_PRICE_ERROR(48004, "最低砍价金额不能为0且不能超过商品可砍金额"),
    ...
    STORE_STATUS_ERROR(50011, "选择的租户店铺已经进行申请或以通过，无法申请,可在我的店铺进行查看"),


    /**
     * NXC 实体店铺
     */
    PHY_STORE_CATEGORY_APPLY_DOUBLE_ERROR(50012, "该实体店分类已存在"),
    PHY_STORE_CATEGORY_SAVE_ERROR(50013, "实体店分类添加失败"),
    PHY_STORE_CATEGORY_NOT_EXIST(50014, "实体店分类不存在"),
    PHY_STORE_CATEGORY_DISABLE_ERROR(50015, "实体店分类禁用失败"),
    PHY_STORE_CATEGORY_NAME_EXIST_ERROR(50016, "实体店分类名称重复！"),
    PHY_STORE_CATEGORY_UPDATE_ERROR(50017, "实体店分类修改失败"),
    PHY_STORE_APPLY_DOUBLE_ERROR(500018, "已经拥有实体店铺!"),
    ...
    VERIFICATION_ERROR(80202, "验证码不正确,请重试"),
