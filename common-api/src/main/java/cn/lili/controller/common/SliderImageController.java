...
public class SliderImageController {
    ...
    public ResultMessage<Object> getSliderImage(@RequestHeader String uuid, @PathVariable VerificationEnums verificationEnums) {
    ...
    public ResultMessage<Object> verificationImage(Integer xPos, @RequestHeader String uuid, @PathVariable VerificationEnums verificationEnums) {
