...
public class CategoryManagerController {
    ...
    @GetMapping(value = "/allChildren/{tenantId}")
    public ResultMessage<List<CategoryVO>> AllList(@PathVariable String tenantId) {
        return ResultUtil.data(this.categoryService.listAllChildrens(tenantId));
    }
