...
public class GoodsManagerController {
    ...
    public ResultMessage<IPage<GoodsVO>> getAuthPage(GoodsSearchParams goodsSearchParams) {
    ...
    @ApiOperation(value = "获取商品查询数据")
    @GetMapping("/goodsData")
    @PreventDuplicateSubmissions
    public ResultMessage<GoodsDataVO> index(String tenantId) {
        return ResultUtil.data(goodsService.getOrderInde(tenantId));
    }
