...
import cn.lili.modules.order.order.entity.vo.OrderDataVO;
...
public class OrderManagerController {
    ...
    @ApiOperation(value = "获取订单查询数据")
    @GetMapping("/orderData")
    @PreventDuplicateSubmissions
    public ResultMessage<OrderDataVO> index(String tenantId) {
        return ResultUtil.data(orderService.getOrderInde(tenantId));
    }
}
