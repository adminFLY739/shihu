...
import cn.lili.modules.page.entity.dto.FeedbackDTO;
...
public class FeedbackManagerController {
    ...
    @GetMapping()
    public ResultMessage<IPage<Feedback>> page(PageVO pageVO, FeedbackDTO feedbackDTO) {
        return ResultUtil.data(feedbackService.queryFeedback(PageUtil.initPage(pageVO),feedbackDTO.queryWrapper()));
    }
