...
public class LogisticsManagerController {
    ...
    public ResultMessage<IPage<Logistics>> getByPage(LogisticsSearchParams logisticsSearchParams) {
        return ResultUtil.data(logisticsService.queryByParams(logisticsSearchParams));
    }
