...
public class IndexStatisticsManagerController {
    ...
    public ResultMessage<IndexStatisticsVO> index(String tenantId) {
        try {
            return ResultUtil.data(indexStatisticsService.indexStatistics(tenantId));
        } catch (Exception e) {
    ...
    @GetMapping("/notice")
    public ResultMessage<IndexNoticeVO> notice(String tenantId) {
        return ResultUtil.data(indexStatisticsService.indexNotice(tenantId));
    }
}
