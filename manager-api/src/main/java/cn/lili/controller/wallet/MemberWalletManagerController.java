...
public class MemberWalletManagerController {
    ...
    public ResultMessage<MemberWalletVO> get(@RequestParam("memberId") String memberId,String tenantId) {
        return ResultUtil.data(memberWalletService.getMemberWallet(memberId,tenantId));
    }
