...
public class RoleManagerController {
    ...
    public ResultMessage<IPage<RoleVO>> select(PageVO pageVo, Role role) {
        IPage<RoleVO> page = roleService.rolePage(PageUtil.initPage(pageVo), PageUtil.initWrapper(role));
