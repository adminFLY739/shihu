...
public class MemberPointsHistoryManagerController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "memberName", value = "用户名称", required = true, paramType = "query")
    })
    @GetMapping(value = "/getByPage")
    public ResultMessage<IPage<MemberPointsHistory>> getByPage(PageVO page, MemberPointsHistoryParams memberPointsHistoryParams) {
        return ResultUtil.data(memberPointsHistoryService.MemberPointsHistoryList(page, memberPointsHistoryParams));
    }
