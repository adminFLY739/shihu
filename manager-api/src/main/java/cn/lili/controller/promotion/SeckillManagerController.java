...
public class SeckillManagerController {
    ...
    @GetMapping
    public ResultMessage<IPage<SeckillVO>> getAll(SeckillSearchParams param, PageVO page) {
        return ResultUtil.data(seckillService.querySeckill(PageUtil.initPage(page),param.queryWrapper()));
    }
