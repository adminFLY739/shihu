...
public class KanJiaActivityGoodsManagerController {
    ...
    @GetMapping
    public ResultMessage<IPage<KanjiaActivityGoodsVO>> getKanJiaActivityPage(KanjiaActivityGoodsParams kanJiaParams, PageVO page) {
        return ResultUtil.data(kanJiaActivityGoodsService.queryKanjiaActivityGoods(PageUtil.initPage(page),kanJiaParams.queryWrapper() ));
    }
