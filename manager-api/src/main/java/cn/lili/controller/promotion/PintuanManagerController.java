...
public class PintuanManagerController {
    ...
    public ResultMessage<IPage<PintuanVO>> getPintuanByPage(PintuanSearchParams queryParam, PageVO page) {
        IPage<PintuanVO> pintuanIPage = pintuanService.queryPintuan(PageUtil.initPage(page),queryParam.queryWrapper());
