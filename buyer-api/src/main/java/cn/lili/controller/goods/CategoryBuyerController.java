...
public class CategoryBuyerController {
    ...
    @GetMapping(value = "/get/{parentId}/{tenantId}")
    public ResultMessage<List<CategoryVO>> list(@NotNull(message = "分类ID不能为空") @PathVariable String parentId,@PathVariable String tenantId) {

        return ResultUtil.data(categoryService.listAllChildren(parentId,tenantId));
    }
}
