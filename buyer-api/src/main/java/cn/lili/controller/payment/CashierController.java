...
public class CashierController {
    ...
    public ResultMessage<Object> paymentParams(@Validated PayParam payParam,String appid) {
    ...
    public ResultMessage<Object> payment(
            ...
            @Validated PayParam payParam,String appid) {
        ...
        try {
            ...
            return cashierSupport.payment(paymentMethodEnum, paymentClientEnum, request, response, payParam,appid);
    ...
    @ApiImplicitParams({
      @ApiImplicitParam(name = "paymentMethod", value = "支付方式", paramType = "path", allowableValues = "WECHAT,ALIPAY"),
      @ApiImplicitParam(name = "appid", value = "小程序appid",paramType = "query")
    })
    @RequestMapping(value = "/notify/{paymentMethod}/{appid}", method = {RequestMethod.GET, RequestMethod.POST})
    public void notify(HttpServletRequest request, @PathVariable String paymentMethod,@PathVariable String appid) {

        PaymentMethodEnum paymentMethodEnum = PaymentMethodEnum.valueOf(paymentMethod);

        cashierSupport.notify(paymentMethodEnum, request , appid);
