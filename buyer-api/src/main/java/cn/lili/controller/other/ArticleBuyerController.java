...
public class ArticleBuyerController {
    ...
    public ResultMessage<Article> getByType(@NotNull(message = "文章类型") @PathVariable("type") String type,String tenantId) {
        return ResultUtil.data(articleService.customGetByType(type,tenantId));
    }
}
