...
public class PageBuyerController {
    ...
    @GetMapping("/getIndex")
    public ResultMessage<PageDataVO> getIndex(@RequestParam String clientType,String tenantId) {
        PageDataDTO pageDataDTO = new PageDataDTO(PageEnum.INDEX.name());
        pageDataDTO.setPageClientType(clientType);
        pageDataDTO.setTenantId(tenantId);
    ...
    @GetMapping("/getStore")
    public ResultMessage<PageDataVO> getShopPage(@RequestParam String clientType,@RequestParam String storeId) {
