...
public class PointsHistoryBuyerController {
    ...
    public ResultMessage<IPage<MemberPointsHistory>> getByPage(PageVO page) {
        ...
        queryWrapper.eq(MemberPointsHistory::getMemberId, Objects.requireNonNull(UserContext.getCurrentUser()).getId());
    ...
    public ResultMessage<MemberPointsHistoryVO> getMemberPointsHistoryVO() {
        return ResultUtil.data(memberPointsHistoryService.getMemberPointsHistoryVO(Objects.requireNonNull(UserContext.getCurrentUser()).getId()));
    }
