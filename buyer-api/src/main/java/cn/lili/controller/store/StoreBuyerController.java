...
public class StoreBuyerController {
    ...
    public ResultMessage<Store> getStoreUser() {
        return ResultUtil.data(storeService.getById(Objects.requireNonNull(UserContext.getCurrentUser()).getStoreId()));
    }
    ...
    public ResultMessage<StoreDetailVO> apply(String tenantId) {
        return ResultUtil.data(storeDetailService.getStoreDetailVOByMemberId(Objects.requireNonNull(UserContext.getCurrentUser()).getId(),tenantId));
    }
