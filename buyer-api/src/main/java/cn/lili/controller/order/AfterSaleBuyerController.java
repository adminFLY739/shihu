...
public class AfterSaleBuyerController {
    ...
    public ResultMessage<List<AfterSaleReason>> getAfterSaleReason(@PathVariable String serviceType,String tenantId) {
        return ResultUtil.data(afterSaleReasonService.afterSaleReasonList(serviceType,tenantId));
    }
