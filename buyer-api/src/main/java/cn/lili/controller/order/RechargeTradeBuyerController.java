...
public class RechargeTradeBuyerController {
    ...
    public ResultMessage<Recharge> create(@Max(value = 10000, message = "充值金额单次最多允许充值10000元") @Min(value = 1, message = "充值金额单次最少充值金额为1元") Double price,String tenantId) {
        Recharge recharge = this.rechargeService.recharge(price,tenantId);
