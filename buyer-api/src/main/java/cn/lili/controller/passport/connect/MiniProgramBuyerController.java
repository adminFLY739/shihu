...
public class MiniProgramBuyerController {
    ...
    public ResultMessage<String> unlimited(String page, String scene,String tenantId) {
        return ResultUtil.data(wechatMpCodeUtil.createCode(page, scene,tenantId));
    }

    @GetMapping("/mp/qrcode")
    @ApiOperation(value = "小程序二维码生成:只适用于少量场景，多数场景需要unlimited接口实现")
    public ResultMessage<String> qrcode(String page,String tenantId) {
        return ResultUtil.data(wechatMpCodeUtil.createQrCode(page,tenantId));
    }
